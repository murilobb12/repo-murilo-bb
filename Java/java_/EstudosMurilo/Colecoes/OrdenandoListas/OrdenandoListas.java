...
public class OrdenandoListas {
    ...
    public static void main(String[] args) {
        ...
        contaCorrentes.sort(saldoComparator2);
        contaCorrentes.stream().forEach(System.out::println);
...
class NomeComparator2 implements Comparator<ContaCorrente> {
    @Override
...
class SaldoComparator2 implements Comparator<ContaCorrente> {
    @Override
    public int compare(ContaCorrente o1, ContaCorrente o2) {
