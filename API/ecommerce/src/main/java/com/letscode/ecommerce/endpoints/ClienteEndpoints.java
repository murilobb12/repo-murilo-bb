...
public class ClienteEndpoints {
    ...
    @RequestMapping(path="/cliente/{id}", method = RequestMethod.GET, produces = APPLICATION_JSON_VALUE)
    public ResponseEntity<Cliente> getClientsByID(@PathVariable long id) {
